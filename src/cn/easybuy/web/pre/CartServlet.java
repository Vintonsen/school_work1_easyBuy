...
import cn.easybuy.service.order.MyOrderServiceImpl;
...
import cn.easybuy.service.user.MyUserAddressServiceImpl;
...
public class CartServlet extends AbstractServlet {
    ...
    public void init() throws ServletException {
        ...
        userAddressService = new MyUserAddressServiceImpl();
    }
    ...
    public Object settlement3(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        String newRemark=new String(request.getParameter("newAddress").getBytes("iso-8859-1"), "utf-8");
